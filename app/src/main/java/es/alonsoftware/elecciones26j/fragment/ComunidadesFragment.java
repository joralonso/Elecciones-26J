...
public class ComunidadesFragment extends android.support.v4.app.Fragment {

    private RecyclerView recyclerView;
    private List<Provincia> provincias;
    private ProvinciasAdapter adapter;

    public static ComunidadesFragment newInstance() {
    ...
    public void onActivityCreated(Bundle state) {
        ...
        String[] provinciasArray = getResources().getStringArray(R.array.comunidades);
        String[] provinciasid = getResources().getStringArray(R.array.comunidades_id);
