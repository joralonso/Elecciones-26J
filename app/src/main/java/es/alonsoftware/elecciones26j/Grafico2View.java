 ...
 */
public class Grafico2View extends View {
    ...
    public Grafico2View(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }

    public Grafico2View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Grafico2View(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (Partido p : partidos2) {
            ...
            canvas.drawArc(new RectF(x +j, y+j, x + diameter-j, y + diameter-j), startAngle, deltaTemp, true, paint);
            startAngle += deltaTemp;
        }
    ...
    public void setData(List<Partido> partidos, List<Partido> partidos2){
